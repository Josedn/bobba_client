...
export const FURNI_PLACEHOLDER = "assets/furni_placeholder.png";
export const FURNI_PLACEHOLDER_OFFSET_X = -34;
export const FURNI_PLACEHOLDER_OFFSET_Y = -49;
...
export const ROOM_WALL_DOOR_EXTENDED_L = "assets/wall_door_extended_l.png";
export const ROOM_WALL_DOOR_EXTENDED_L_OFFSET_X = -8;
export const ROOM_WALL_DOOR_EXTENDED_L_OFFSET_Y = -139;
